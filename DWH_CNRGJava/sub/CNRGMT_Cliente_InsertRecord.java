...
public class CNRGMT_Cliente_InsertRecord extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			String sel = "Select * from "+ UserCNRG + ".B2073_TO_IN_CLIENTE where AUDIT_DATA_ELAB_DWH is null";
	        ...
	        while (rs.next()) {
				...
				int nr = rsmd.getColumnCount();
		         ...
		         for(int i=1; i<=nr; i++){
		    			...
		    			if (C1.equals("IMPORTO_FIDEIUSSIONE")){
		    				C1 = "IMPORTO_GARANZIE";
		    			}
		    		...
		    		if (!C1.equals("DATA_INSERIMENTO")){
		    			...
		    			} else if (C1.startsWith("AUDIT_DATA") ){
		    			...
		    			Insert = "INSERT INTO STAGING_DWH.CNRGLM_IN_CLIENTE ("+ColonneIns+") VALUES ('" + ValueIns +")";
		    			...
		    			Insert = "UPDATE STAGING_DWH.CNRGLM_IN_CLIENTE  SET "+ValueUpdate+" WHERE " + ValueQuery +"";
						...
						String Update = "UPDATE "+ UserCNRG + ".B2073_TO_IN_CLIENTE SET AUDIT_DATA_ELAB_DWH = to_date (sysdate)  where " + UPPQuery;
			...
			String SemaforoUP = "UPDATE STAGING_DWH.CNRGLM_SEMAFORO SET STATO_ELABORAZIONE = 1, TS_FINE = SYSDATE WHERE NOME_TABELLA = 'CNRGLM_IN_CLIENTE' and STATO_ELABORAZIONE = 0 and TIPO_ELABORAZIONE = 'C'";
