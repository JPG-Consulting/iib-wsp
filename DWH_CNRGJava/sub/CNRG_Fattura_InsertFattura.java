...
public class CNRG_Fattura_InsertFattura extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			if (C1.equals("ID_SISTEMA_PROVENIENZA_DATI") ||C1.equals("ID_SOCIETA_COMPETENZA") || C1.equals("ID_FORNITURA")|| C1.equals("ID_FATTURA") ){
			...
			String SemaforoUP = "UPDATE STAGING_DWH.CNRGDIS_SEMAFORO SET STATO_ELABORAZIONE = 1 WHERE NOME_TABELLA = 'CNRGDIS_IN_FATTURA' and STATO_ELABORAZIONE = 0";
