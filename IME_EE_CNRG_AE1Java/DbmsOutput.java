...
class DbmsOutput {	
	...
	*/
	...
	public void printFile(String fileName) throws SQLException
	{
	  try{
	  int done = 0;
	  show_stmt.registerOutParameter( 2, java.sql.Types.INTEGER );
	  ...
	  BufferedWriter out = new BufferedWriter(fstream);
	    ...
	    {   
	        show_stmt.setInt( 1, 32000 );
	        show_stmt.executeUpdate();
	        out.write(show_stmt.getString(3) );
	        if ( (done = show_stmt.getInt(2)) == 1 ) break;
	    } 
	    ...
	    out.close();
	     ...
	     // m_messenger.outTraceln("Error writing sysout to file: " + e.getMessage());
	  }
	}
