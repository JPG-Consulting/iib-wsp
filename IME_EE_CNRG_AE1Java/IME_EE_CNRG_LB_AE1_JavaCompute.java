...
public class IME_EE_CNRG_LB_AE1_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			try{
				conn = getJDBCType4Connection("C2",JDBC_TransactionType.MB_TRANSACTION_AUTO); // C2 --> MERCATO LIBERO				
				...
				if (result.equals("255")){
					...
					String path ="/ibmdata/download/SII/CNRG_LB/OUTBOUND/"; 
					String fileOut  = "";
					String fileName = "";
					while (resultSet.next()) {
						 fileName = resultSet.getString("NOME_FILE");
						 fileOut =  path + fileName ;
						 File data = new File(fileOut);
					...
					// Copio il file nella cartella dove leggerà l'applicazione verso hub (IME_EE_HUB_CNRG)
					String dest ="/ibmdata/WINSHARE/CNRG_LB/SII/AE1.0050/IN";
					Runtime.getRuntime().exec("cp "+fileOut+ " "+dest);
